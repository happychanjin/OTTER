...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "100593238", nullptr, nullptr);
...
int main() {
	...
	// Push another scope so most memory should be freed *before* we exit the app
	{
		...
		Texture2D::sptr reflax = Texture2D::LoadFromFile("images/reflax.png");
		// Load the cube map
		...
		//tester
		material0->Set("s_reflax", reflax);
		
		material0->Set("u_Shininess", 100000000.0f);
