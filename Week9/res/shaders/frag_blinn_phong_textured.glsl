...
void main() {
	...
	float texReflax = texture(s_reflax, inUV).t;
	vec3 reflaxR = texReflax * environment;
	////////////////////////////////
	...
	vec3 result = (
		...
		(ambient + diffuse  + specular) * attenuation + reflaxR // light factors from our single light
